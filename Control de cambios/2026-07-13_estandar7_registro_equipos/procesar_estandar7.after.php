...
if (!in_array($accion, ['guardar_recursos', 'guardar_analisis_consumo', 'guardar_epp_entrega', 'enviar_codigo_epp', 'firmar_epp_entrega', 'guardar_programa_documental', 'guardar_mantenimiento_equipo'], true)) {
...
if (in_array($accion, ['guardar_recursos', 'guardar_analisis_consumo', 'guardar_epp_entrega', 'guardar_programa_documental', 'guardar_mantenimiento_equipo'], true) && $rol !== 'sst') {
    ...
    try {
        ...
        $stmtInsert = $conn->prepare("
            INSERT INTO estandar7_mantenimiento_equipos (
                ...
                fabricante, direccion, telefono, creado_por
            ) VALUES (
                :empresa_id, :codigo_interno, :tipo_elemento, :nombre_elemento, :marca,
                :serie, :modelo, :tipo_energia_json, :ubicacion, :seccion, :tipo_combustible,
                :fabricante, :direccion, :telefono, :creado_por
