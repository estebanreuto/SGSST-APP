...
<head>
    ...
    <style>
        ...
        * { box-sizing:border-box; }
        ...
        .maintenance-field select[multiple] {
            min-height:112px;
        }
                ...
                <?php elseif ($modulo_actual === 'mantenimiento'): ?>
                            ...
                            <section class="maintenance-form-panel">
                                <div class="maintenance-form-head">
                                    <div>
                                        ...
                                        <p>Registra la información base del activo. El código interno se asigna automáticamente al guardar.</p>
                                    </div>
                                ...
                                <form method="post" action="procesar_estandar7.php">
                                    ...
                                    <div class="maintenance-form-grid">
                                        ...
                                        <div class="maintenance-field">
                                            ...
                                            <input type="text" name="nombre_elemento" placeholder="Ej. Compresor, pulidora, taladro" required>
                                        </div>
                                        <div class="maintenance-field">
                                            <label>Marca</label>
                                        ...
                                        <div class="maintenance-field">
                                            ...
                                            <input type="text" name="serie" placeholder="Serial del fabricante">
                                        </div>
                                        <div class="maintenance-field">
                                            <label>Modelo</label>
                                        ...
                                        <div class="maintenance-field">
                                            ...
                                            <input type="text" name="tipo_combustible" placeholder="Gasolina, ACPM, gas, no aplica">
                                        </div>
                                        <div class="maintenance-field">
                                        ...
                                        <div class="maintenance-field wide">
                                            ...
                                            <input type="text" name="direccion" placeholder="Dirección asociada al equipo o proveedor">
                                        </div>
                                        <div class="maintenance-field">
                                        ...
                                        <div class="maintenance-field full">
                                            ...
                                            <select name="tipo_energia[]" multiple>
                                                <?php foreach ($catalogo_energias_mantenimiento as $energiaValor => $energiaNombre): ?>
                                                    <option value="<?php echo e7h($energiaValor); ?>"><?php echo e7h($energiaNombre); ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                            <span class="maintenance-help">Puedes seleccionar varias energías cuando el equipo combine fuentes, por ejemplo eléctrica y neumática, o neumática y combustión.</span>
                                        </div>
                                    </div>
                                    ...
                                    <table class="epp-list-table">
                                        ...
                                        <tbody>
                                            <?php if (!$mantenimiento_equipos): ?>
                                                <tr><td colspan="8">No hay equipos, máquinas o herramientas registrados.</td></tr>
                                            <?php else: ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="placeholder-panel">
                            <div class="info-box">
                                <h3>Base de seguimiento</h3>
                                <ul class="info-list">
                                    <li><i class="fa-solid fa-check"></i><span>Los equipos registrados quedarán disponibles aquí para conectar la programación de mantenimiento.</span></li>
                                    <li><i class="fa-solid fa-database"></i><span>Registros actuales: <?php echo count($mantenimiento_equipos); ?>.</span></li>
                                </ul>
                            </div>
                        </div>
                    <?php endif; ?>
