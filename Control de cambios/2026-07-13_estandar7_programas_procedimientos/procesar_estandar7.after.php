...
if (!in_array($accion, ['guardar_recursos', 'guardar_analisis_consumo', 'guardar_epp_entrega', 'enviar_codigo_epp', 'firmar_epp_entrega', 'guardar_programa_documental'], true)) {
...
if (in_array($accion, ['guardar_recursos', 'guardar_analisis_consumo', 'guardar_epp_entrega', 'guardar_programa_documental'], true) && $rol !== 'sst') {
