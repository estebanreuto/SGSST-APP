...
<head>
    ...
    <style>
        ...
        .panel-container.rep-view { grid-template-columns: minmax(0, 1fr); gap: 0; }
        ...
        .rep-pila-strip { display: grid; grid-template-columns: minmax(210px, 0.9fr) minmax(0, 1.7fr); gap: 16px; align-items: stretch; background: #fff; border: 1px solid var(--border); border-left: 4px solid var(--primary2); border-radius: 14px; padding: 16px; margin: -8px 0 22px; box-shadow: 0 4px 15px rgba(0,0,0,0.02); }
        ...
        .rep-pila-facts { display: grid; grid-template-columns: repeat(4, minmax(110px, 1fr)); gap: 10px; min-width: 0; }
        ...
        .rep-table-wrap { width: 100%; max-width: 100%; max-height: clamp(360px, 52vh, 620px); overflow: auto; border: 1px solid #e2e8f0; border-radius: 12px; background: #fff; scrollbar-gutter: stable; }
        .rep-table-wrap::-webkit-scrollbar { width: 8px; height: 8px; }
        ...
        .rep-summary-table th { position: sticky; top: 0; z-index: 2; background: #f8fafc; color: #475569; font-size: 0.58rem; text-transform: uppercase; letter-spacing: 0.035em; text-align: left; padding: 9px 7px; border-bottom: 1px solid #e2e8f0; line-height: 1.15; }
