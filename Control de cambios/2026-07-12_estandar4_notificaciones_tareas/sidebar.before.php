            ...
            <?php if ($usuario_rol === 'representante' || $usuario_rol === 'sst'): ?>
                ...
                <div class="nav-dropdown" id="dropdownPEM">
                    ...
                    <div class="nav-dropdown-menu">
                        ...
                        <?php for($i = 1; $i <= 7; $i++): ?>
                            <?php if ($i === 5): ?>
                                <div class="standard-submodules <?php echo $estandar5_activo ? 'active' : ''; ?>">
                                    <div class="sub-item std-item has-children <?php echo $estandar5_activo ? 'active' : ''; ?>" data-search="<?php echo $i . ' ' . strtolower(htmlspecialchars($nombres_estandares[$i] . ' ' . implode(' ', $estandar5_submodulos))); ?>">
                                        <a href="estandar5.php" class="submodule-parent-link" onclick="window.location.href='estandar5.php'; return false;">
                                            <span><?php echo htmlspecialchars($nombres_estandares[$i]); ?></span>
                                        </a>
                                        <button type="button" class="submodule-toggle" aria-label="Ver submódulos del estándar 5" aria-expanded="<?php echo $estandar5_activo ? 'true' : 'false'; ?>">
                                    ...
                                    <div class="submodule-menu">
                                        <?php foreach ($estandar5_submodulos as $modulo_slug => $modulo_nombre): ?>
                                            <a href="estandar5.php?modulo=<?php echo urlencode($modulo_slug); ?>" class="submodule-link <?php echo $estandar5_activo && ($_GET['modulo'] ?? '') === $modulo_slug ? 'active' : ''; ?>">
