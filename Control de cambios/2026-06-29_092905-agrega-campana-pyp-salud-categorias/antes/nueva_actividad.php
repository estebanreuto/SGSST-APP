...
$categorias_capacitacion_base = ['Biológico', 'Físico', 'Químico', 'Psicosocial', 'Biomecánicos', 'Mecánico', 'Eléctrico', 'Locativo', 'Seguridad Vial', 'Públicos', 'Trabajo en alturas', 'Legal'];
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function updateCategoryOptions() {
                ...
                const previous = categoriaCapacitacion.value || categoriaInicial;
                ...
                if (options.length === 1 && !categoriaCapacitacion.value) {
