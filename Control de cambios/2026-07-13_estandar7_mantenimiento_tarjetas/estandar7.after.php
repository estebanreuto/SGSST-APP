        ...
        <?php else: ?>
            ...
            <section class="section-card">
                ...
                <?php elseif ($modulo_actual === 'mantenimiento'): ?>
                    ...
                    ?>
                    <div class="procedure-category-grid" style="grid-template-columns:repeat(2, minmax(0, 1fr));">
                        <?php foreach ($mantenimientoCategorias as $categoria): ?>
                            <article class="procedure-category-card">
                                <div>
                                ...
                                <span class="procedure-category-status">Pendiente de estructura</span>
                            </article>
                        <?php endforeach; ?>
                    </div>
