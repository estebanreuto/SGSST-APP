...
<body>
    ...
    <script>
        ...
        // === EVENT LISTENERS ===
        document.getElementById('filtroTexto').addEventListener('input', aplicarFiltrosJS);
        ...
        btnToday.addEventListener('click', () => {
            ...
            const mesSelect = document.getElementById('filtroMes').value;
            const anioSelect = document.getElementById('filtroAnio').value;
